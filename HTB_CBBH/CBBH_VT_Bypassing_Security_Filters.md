...
> [!NOTE] IMPORTANT
> 
> What this is saying is that, certain vulnerabilities can co-exist. For example: command injections inside of HTTP Verb Vuln

## Exercise
![[Pasted image 20250316223959.png]]
Checking which verb it accepts
We can use change request methods to POST
![[Pasted image 20250316224102.png]]
![[Pasted image 20250316224112.png]]

![[Pasted image 20250316224126.png]]
## Identify
